...
class AiAssistantToolExecutor
{
                ...
                'function' => [
                    ...
                    'parameters' => [
                        ...
                        'properties' => [
                            ...
                            'monitoring_method' => [
                                'type' => 'string',
                                'enum' => array_keys(Service::monitoringMethods()),
                            ],
                            'expect_type' => [
                                'type' => 'string',
    ...
    private function inspectService(User $user, string $identifier): array
    {
        ...
        $payload = [
            ...
            'service' => [
                ...
                'monitoring_method' => $service->monitoringMethodLabel(),
    ...
    private function createService(array $arguments): array
    {
        ...
        $payload = [
            ...
            'monitoringMethod' => Arr::get($arguments, 'monitoring_method', Arr::get($templateDefaults, 'monitoringMethod', Service::MONITOR_HTTP)),
    ...
    private function updateService(array $arguments): array
    {
        ...
        $payload = [
            ...
            'monitoringMethod' => Arr::get($arguments, 'monitoring_method', $service->monitoringMethod()),
            'expectType' => $expectType,
