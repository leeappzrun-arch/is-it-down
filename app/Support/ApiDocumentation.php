...
class ApiDocumentation
{
    ...
    public static function endpoints(): array
    {
        return [
            ...
            [
                'key' => 'service-downtimes.index',
                'label' => 'List service downtime incidents',
                'method' => 'GET',
                'path' => '/api/v1/services/{service}/downtimes',
                'permission' => 'history:read',
                'description' => 'Return downtime history for one service, including durations, screenshots, failed response headers, and any Dave outage analysis.',
                'query_parameters' => [
                    ['name' => 'status', 'required' => false, 'description' => 'Use `ongoing` or `resolved`.'],
                    ['name' => 'per_page', 'required' => false, 'description' => 'Set the paginator size up to 100.'],
                ],
                'body_example' => null,
            ],
            [
                'key' => 'service-downtimes.show',
                'label' => 'Show service downtime incident',
                'method' => 'GET',
                'path' => '/api/v1/service-downtimes/{service_downtime}',
                'permission' => 'history:read',
                'description' => 'Return one downtime incident with its screenshot URL, failed response headers, AI summary, and timing details.',
                'query_parameters' => [],
                'body_example' => null,
            ],
            [
            ...
            [
                ...
                'permission' => 'services:read',
                'description' => 'Return one service with its assignments, latest screenshot, failed response headers, and monitoring state.',
                'query_parameters' => [],
                'body_example' => null,
            ],
            [
