    ...
    public static function endpoints(): array
    {
        return [
            ...
            [
                ...
                'query_parameters' => [
                    ['name' => 'search', 'required' => false, 'description' => 'Filter by service details, expectation, or assigned groups and recipients.'],
            ...
            [
                ...
                'description' => 'Create a monitored service using the same validation rules as the Services page. You can also pass a saved service template id or exact name and then override any fields you want to change.',
                'query_parameters' => [],
                'body_example' => [
            ...
            [
                ...
                'query_parameters' => [
                    ['name' => 'search', 'required' => false, 'description' => 'Filter by template name, default service name, or expectation.'],
