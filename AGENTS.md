...
- If DDEV commands are blocked by sandbox or Docker permission issues, request the needed DDEV/Docker access for the session and retry before using host-level Artisan or declaring DDEV unavailable.
